...
void
CNS::compute_dSdt (const MultiFab& S, MultiFab& Prim, MultiFab& Prim_eb, MultiFab& grad_eb, MultiFab& dSdt, Real dt,
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	amrex::ParallelFor(amrex::grow(bx,0), 1,
		...
		//std::cout << vfrac(i,j,k,0) << " " << grad_eb_arr(i,j,k,0) << "\n";
		}
	});
